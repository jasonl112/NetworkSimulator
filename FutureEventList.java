public interface FutureEventList {
     ...
     * <br>
     * The FutureEventList is sorted by arrival time, so the Event at the front of
     * the list will be the one with the
    ...
    /**
     * Return the list capacity (total number of Events the list can store before
     * having to resize it).
     *
